...
export default async function CustomersPage({ searchParams }: PageProps<"/app/customers">) {
  ...
  return <div><PageHeading title="Saved customers" description={`Reusable customer details for ${data.context.workspace.name}. Documents can always be created without saving a customer first.`} />
