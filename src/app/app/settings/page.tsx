      ...
      <section id="plan-storage" className="mt-6 rounded-xl border border-border bg-surface p-5 sm:p-7" aria-labelledby="plan-storage-heading">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm leading-6 text-muted">Review the beta plan, member capacity, monthly allowance, carry-forward document credits, and payment history.</p>
          </div>
