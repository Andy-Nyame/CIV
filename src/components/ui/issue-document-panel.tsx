...
export function IssueDocumentPanel({ documentId, documentType, customerName, currency, grandTotal, readiness, capacity, requiresGraAcknowledgement = false }: {
  documentId: string;
  documentType: string;
  ...
  requiresGraAcknowledgement?: boolean;
}) {
